...
{
    public sealed class GenericVarianceTypeCompatibilityPolicy : ITypeCompatibilityPolicy
    {

        public static readonly GenericVarianceTypeCompatibilityPolicy Instance = 
            new GenericVarianceTypeCompatibilityPolicy();
