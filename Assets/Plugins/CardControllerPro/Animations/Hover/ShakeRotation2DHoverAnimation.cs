...
public class ShakeRotation2DHoverAnimation : IHoverAnimation
{
    ...
    public void Hover(Card card)
    {
        ...
        card.cardHoverer.transform.DOShakeRotation(duration, new Vector3(0, 0, strength), vibrato, randomness)
